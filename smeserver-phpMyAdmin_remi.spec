...
Summary: remi version of phpMyAdmin for SME Server 
%define name smeserver-phpMyAdmin_remi
Name: %{name}
...
%description
Implementation of remi version of phpMyAdmin for SME Server.
Access with admin username/password via: https://yourdomain/phpmyadmin.

%changelog
* Mon Aug 4 2014 stephane de labrusse <stephdl@de-labrusse.fr> 4.2.7-1
- upgrade to 4.2.7
- corrected minor error in template.metadata
